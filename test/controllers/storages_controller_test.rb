...
class StoragesControllerTest < ActionController::TestCase
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post :create, storage: { area: @storage.area, location: @storage.location, name: @storage.name, phone: @storage.phone }
    end
  ...
  test "should update storage" do
    patch :update, id: @storage, storage: { area: @storage.area, location: @storage.location, name: @storage.name, phone: @storage.phone }
    assert_redirected_to storage_path(assigns(:storage))
  end
